...
<i class="fa fa-money fa-fw"> </i> Add Provider Company
...
<label class="col-md-3 control-label"> Provider Company Name </label>
...
<label class="col-md-3 control-label"> Show Providers </label>
...
<label class="col-md-3 control-label"> Select Provider Company Image </label>
