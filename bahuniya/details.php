  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Show </span>Products
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<label class="col-md-5 control-label" >Select Quantity </label>
...
<i class="fa fa-shopping-cart" ></i> Add to the Cart

</button>

<button class="btn btn-warning" type="submit" name="add_wishlist">

<i class="fa fa-heart" ></i> Add to the Wishlist
...
<h3 class="text-center"> Most Trendy top products of BAUHINIYA </h3>
